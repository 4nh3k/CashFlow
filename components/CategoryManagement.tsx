...
import { selectCategoriesLoading, createCategory, updateCategory, selectCategories, deleteCategory, selectCategoriesError, fetchCategories } from '@/lib/slices/categorySlice'
            ...
            <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-blue-700 text-xs sm:text-sm">Total Categories</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 p-3 sm:p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-red-700 text-xs sm:text-sm">Expense Categories</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  ...
                  <p className="text-green-700 text-xs sm:text-sm">Income Categories</p>
                </div>
              </div>
            </div>
          </div>
